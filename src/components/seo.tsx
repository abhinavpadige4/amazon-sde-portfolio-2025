...
export default function SEO({
  ...
  description =
    "Software Development Engineer specializing in AWS cloud architecture, distributed systems, and scalable backend solutions. Passionate about solving complex problems at scale.",
  image = "/og-image.jpg",
}: SEOProps) {
  return (
    <>
